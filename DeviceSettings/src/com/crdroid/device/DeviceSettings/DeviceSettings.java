...
import com.crdroid.device.DeviceSettings.ModeSwitch.DCModeSwitch;
import com.crdroid.device.DeviceSettings.ModeSwitch.HBMModeSwitch;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent hbmIntent = new Intent(getContext(),
                    com.crdroid.device.DeviceSettings.HBMModeService.class);
            if (enabled) {
