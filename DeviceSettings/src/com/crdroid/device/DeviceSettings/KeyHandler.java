...
package com.crdroid.device.DeviceSettings;
...
import com.crdroid.device.DeviceSettings.Constants;
import com.crdroid.device.DeviceSettings.DeviceSettings;
import com.crdroid.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("com.crdroid.device.DeviceSettings",
